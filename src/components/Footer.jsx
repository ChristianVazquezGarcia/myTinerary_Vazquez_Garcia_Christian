...
const Footer = () => {
  return (
    <>
      <footer className="flex flex-wrap w-full  max-md:flex-col max-md:items-center ">
        ...
        <div className="flex flex-col w-1/3 border-2 items-center max-md:w-full max-md:border-none justify-center ">
          <Menu props="flex-col " />
        </div>
      </footer>
    </>

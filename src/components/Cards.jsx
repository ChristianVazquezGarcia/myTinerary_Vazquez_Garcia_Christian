...
const Cards = ({ props, style }) => {
    return (
        <article className="relative w-[300px] h-[300px] max-lg:w-[200px] max-lg:h-[150px] max-md:w-[250px] max-md:h-[150px] rounded-lg  flex flex-col items-center responsive mb-16">
